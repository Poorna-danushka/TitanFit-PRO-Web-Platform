...
export default function ProgressPage() {
  ...
  const currentWeightNum = Number(weight) || (user?.weight ? Number(user.weight) : null);
  const weightTrendData = currentWeightNum
    ? [
        { date: 'Initial', weight: currentWeightNum },
        { date: 'Current', weight: currentWeightNum },
      ]
    : [];
          ...
          <div className="h-64 w-full">
            {weightTrendData.length === 0 ? (
              <div className="h-full flex items-center justify-center text-xs text-gray-500">
                Log your body weight to view your progress trend graph.
              </div>
            ) : (
